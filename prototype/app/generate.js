...
// 路径: prototype/app/generate.js  v1.13.2
...
(function () {
  ...
  // opts: { mode, checkedPkgs:Set, customEl, outputEl, statEl, riskMap }
  function generate(opts) {
    const { mode, checkedPkgs, customEl, outputEl, statEl, riskMap } = opts;
    ...
    if (pkgs.length === 0) {
      outputEl.innerHTML = "// 勾选应用或粘贴自定义包名后将在此生成 adb 命令";
      statEl.textContent = "已选 0";
      return;
    }
